...
- Bản phát hành không chứa mật khẩu quản trị hoặc secret công khai.
...
- Không kiểm tra hoặc phát hành mật khẩu quản trị trong gói mã nguồn; thông tin đăng nhập phải được quản lý riêng.
